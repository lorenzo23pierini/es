...
int Compare::findSmaller(int arrayIn[], int size) //Quello che fa il programma è ordinare gli elemnti dell'array in modo tale che il più piccolo sia lo zero-esimo elemento. Per poi restituire proprio quello.
{
    {
