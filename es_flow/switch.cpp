...
int main()
{
    ...
    switch(menuItem) //With break one case selected is only run
    {
    ...
    switch(begin) //Without break command the programme run all the case under the char insert by the user
    {
